...
We created this GUI program for assessing tephra fall hazards based on a database of Isopach maps (prototype version) by Shimpei Uesawa using R-Shiny with R-studio.
The original script and source data are available at https://github.com/s-uesawa/Prototype-TephraDB-Japan and https://doi.org/10.5281/zenodo.7672678.
...
Disclaimers; CRIEPI and the author, the original data acquirer/creator, and the database administrator shall not be held liable for any loss or damage arising from the use of this database.
